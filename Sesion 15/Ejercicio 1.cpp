...
public:
   ...
   Punto2D Centro(){
      Punto2D coord_centro;
      mitad = longitud / 2;
      
      coord_centro.Abscisa(esquina_abscisa+mitad);
      coord_centro.Ordenada(esquina_ordenada+mitad);
   ...
   Circunferencia CircunferenciaInscrita(){
      ...
      inscrita.AbscisaCentro(esquina_abscisa+radio);
      inscrita.OrdenadaCentro(esquina_ordenada+radio);
      inscrita.Radio();
   ...
   Circunferencia CircunferenciaCircunscrita(){
      ...
      radio.Longitud();
      circunscrita.AbscisaCentro(esquina_abscisa+radio);
      circunscrita.OrdenadaCentro(esquina_ordenada+radio);
   ...
   bool Contiene(Cuadrado otro){
      double otra_longitud;
      otra_longitud = otro.Longitud();
...
int main(){
   ...
   Cuadrado circunf_interior_cuadrado,circunf_exterior_cuadrado;
   
   circunf_interior_cuadrado = cuadrado_A.CircunferenciaInscrita();
   circunf_exterior_cuadrado = cuadrado_A.CircunferenciaCircunscrita();
